...
def augmentAruco(bbox , id,approx,img,imgAug , drawid=True):
...
for contour in contours:
    ...
    if len(approx) == 4:
        ...
        if aspectRatio >= 0.95 and aspectRatio <= 1.05:
            ...
            blue = img[y+35, x+30, 0]
            green = img[y+35, x+30, 1]
            red = img[y+35, x+30, 2]

            if blue > 70 and blue < 85  and  green > 200 and green < 210 and  red > 140 and red < 150:
                arucoFound = findarucoMarkers(img2)
                if len(arucoFound[0]) != 0:
                    for bbox, id in zip(arucoFound[0], arucoFound[1]):
                        img = augmentAruco(bbox, id, approx, img, img1)

            if blue > 10 and blue < 20 and  green > 120 and green < 130 and  red > 230 and red < 235:
                arucoFound = findarucoMarkers(img2)
                if len(arucoFound[0]) != 0:
                    for bbox, id in zip(arucoFound[0], arucoFound[1]):
